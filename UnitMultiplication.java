...
public class UnitMultiplication {
    ...
    public static class TransitionMapper extends Mapper<Object, Text, Text, Text> {
        ...
        @Override
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException { // 写出text还是Double? 这里只能是Text
    ...
    public static class PRMapper extends Mapper<Object, Text, Text, Text> {
        ...
        @Override
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException { // 写出text还是Double? 这里都可以，怎么方便用什么
            String[] pr = value.toString().trim().split("\t");
            context.write(new Text(pr[0]), new Text(pr[1]));
        }
    }

    public static class MultiplicationReducer extends Reducer<Text, Text, Text, Text> { // 写出text还是Double? 这里都可以，怎么方便用什么
